<?php 
include "config.php";
$result = mysqli_query($con, "SELECT * FROM randevu WHERE eposta='".$_SESSION['email']."'");
?>
...
<head>
    ...
    <title>Özel Hastanesi - Randevularim</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-sm ">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="randevuform.html" target="_blank">RANDEVU YAP</a>
                </li>
            </ul>
  ...
  <div class="column menu">
    <ul>
      <li><a class="letter" href="bilgilerim.php"><img src="img/profile.png" weight="50px" height="50px"> Bilgilerim</a></li>
      <a class="letter" href="oncekirandevularim.php"><li><img src="img/appointment.png" weight="50px" height="50px">Randevularım</li></a>
      <li><a class="letter" href="mesajlarim.html"><img src="img/message.png" weight="40px" height="40px"> Mesajlarım</a></li>
      <li><a class="letter" href="ayarlar.html"><img src="img/clipart494368.png" weight="50px" height="50px"> Ayarlar</a></li>
    </ul>
  </div> 

  <div>
    <img src="img/appointment.png" weight="100px" height="100px">
    <h1>Randevularım</h1>
    <div class="column2 menu2">
        <?php while($row = mysqli_fetch_assoc($result)) : ?>
        
        <ul>
        <li>Ad Soyad : <?= $row["adsoyad"] ?><br>
          Cinsiyet : <?= $row["cinsiyet"] ?><br>
          E Posta : <?= $row["eposta"] ?><br>
          Dogum Tarih : <?= $row["dogumtarih"] ?><br>
          TC Kimlik : <?= $row["tckn"] ?><br>
          Telefon No : <?= $row["tel"] ?><br>
          Poliklinik : <?= $row["poliklinik"] ?><br>
          Randevu Tarih : <?= $row["randevutarih"] ?></li>
        </ul>
